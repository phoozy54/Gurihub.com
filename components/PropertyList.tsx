...
import { Property, PropertyStatus, User, Currency } from '../types';
...
export const PropertyList: React.FC<PropertyListProps> = ({ properties, setProperties, addActivity, currentUser }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
           <h1 className="text-2xl font-bold text-gray-800">Hantida / Guryaha</h1>
           <p className="text-sm text-gray-500">Manage real estate listings and availability</p>
        </div>
        <div className="flex gap-3">
          <div className="flex bg-white border border-gray-200 rounded-lg p-1 shadow-sm">
             <button 
               onClick={() => setViewMode('list')}
               className={`p-2 rounded-md transition-all ${viewMode === 'list' ? 'bg-gray-100 text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
               title="List View"
             >
                <List size={18} />
             </button>
             <button 
               ...
               className={`p-2 rounded-md transition-all ${viewMode === 'map' ? 'bg-gray-100 text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
               title="Map View"
             >
                <MapIcon size={18} />
             </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {properties.map((prop) => (
          <div key={prop.id} className="bg-white rounded-xl overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow group">
            ...
            <div className="p-5">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4 py-4 border-t border-gray-100">
                <div>
                  <p className="text-xs text-gray-500 mb-1">Qaybaha (Units)</p>
                ...
                <div>
                  <p className="text-xs text-gray-500 mb-1">Nooca</p>
                  <div className="flex items-center text-gray-800 font-medium">
              ...
              <div className="mt-2 flex justify-between items-center">
                <div className="w-full bg-gray-100 rounded-full h-2 mr-4 overflow-hidden">
                  <div 
              ...
              <button className="w-full mt-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-brand-600 transition-colors flex items-center justify-center">
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-2xl">
            <div className="flex justify-between items-center mb-4">
               <h2 className="text-lg font-bold text-gray-800">Ku dar Guri Cusub</h2>
               <button onClick={() => setIsModalOpen(false)} className="text-gray-400 hover:text-gray-600"><X size={20} /></button>
            </div>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Magaca Hantida</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Cinwaanka (Address)</label>
                <input 
                  type="text" 
                  className="w-full border border-gray-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-brand-500 outline-none"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Nooca</label>
                  <select 
                    className="w-full border border-gray-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-brand-500 outline-none"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Cadadka Unit-yada</label>
                  <input 
                    type="number" 
                    className="w-full border border-gray-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-brand-500 outline-none"
                    min="1"
              ...
              <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 flex items-center gap-3 text-gray-500 text-sm">
                 <ImageIcon size={16} />
